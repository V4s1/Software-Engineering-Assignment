...
if(isset($_POST['type']) && isset($_POST['distance']) && isset($_POST['duration']) && isset($_POST['date'])) {
...
$sql = "INSERT INTO activities (user_id, type, distance, duration, date) VALUES ('{$_SESSION['id']}', '$type', '$distance', '$duration', '$date')";
